...
class ListField(ApiField):
    """
    Provides access to a django-mongodb-engine List field
    Requires django-nonrel 
    """
...
class EmbeddedListField(ToManyField):
    """
    Provides access to a list of embedded objects. Think of it as a join for
    non-relational backends.
    Requires django-nonrel and django-mongodb-engine models
    """
    is_related = False
    is_m2m = False
...
class DictField(ApiField):
    """
    Provides access to a django-mongodb-engine dictionary embedded in the
    resource
    Requires django-nonrel and django-mongodb-engine
    """
...
class EmbeddedModelField(ToOneField):
    """
    Provides access to an embedded object. Think of it as a FK for non-relational backends
    Requires django-nonrel and django-mongodb-engine
    """
    is_related = False
